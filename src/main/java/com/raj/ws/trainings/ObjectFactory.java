 ...
 * generated in the com.raj.ws.trainings package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://trainings.ws.raj.com/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://trainings.ws.raj.com/", "getOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://trainings.ws.raj.com/", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://trainings.ws.raj.com/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.raj.ws.trainings
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.raj.com/", name = "getOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.raj.com/", name = "getOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.raj.com/", name = "createOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://trainings.ws.raj.com/", name = "createOrdersResponse")
